...
print"%i + %i = %i"%(int(in1),int(in2),int(in1+in2))#math problem 1
print"PrissyBot: Now division."
in1 = raw_input("Enter an integer: ")
in2 = raw_input("Enter a 2nd integer: ")
print"%i / %i = %i"%(int(in1),int(in2),int(in1)/int(in2))#math problem 2 using ints
if float(in1)%float(in2)!=0:#checks to see if the math apeared strange due to integer math
